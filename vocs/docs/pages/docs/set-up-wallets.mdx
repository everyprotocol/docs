...
Every Network supports [unified accounts](/docs/network/accounts), allowing users to use the same address and private key as on their preferred universe chains.
