...
Every Network supports [unified accounts](/docs/network/accounts), allowing you to use the same address and private key across both types of chains.
...
You can use **cast** to create or import wallets. See the [cast wallet reference](https://getfoundry.sh/cast/reference/wallet/) for details.
